...
<nav class="navbar navbar-expand-lg bg-body-tertiary"  data-bs-theme="dark">
        <div class="container-fluid">
          ...
          <a class="navbar-brand" href="{{ route('contacto') }}">Minimarket <img src="#" alt="" width="50"></a>
        ...
        <div class="caja">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-outline mb-4">
                    ...
                    <input type="email" name="email" id="form2Example11" class="form-control" placeholder="Correo" required />
                ...
                <div class="text-center pt-1 mb-5 pb-1">
                    <button class="btn btn-custom btn-block fa-lg gradient-custom-2 mb-3 w-100" type="submit">Iniciar Sesión</button>

                    <p>¿No tienes una cuenta?</p>  <a class="forgot" href="{{ route('register') }}"> Regístrate aquí</a>
                </div>
            </form>
        </div>
      </div>
